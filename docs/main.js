...
var Caml_utils = __webpack_require__(23);
var Caml_builtin_exceptions = __webpack_require__(0);
...
var Caml_format = __webpack_require__(4);
var Caml_string = __webpack_require__(2);
var Caml_exceptions = __webpack_require__(9);
var Caml_missing_polyfill = __webpack_require__(10);
var Caml_builtin_exceptions = __webpack_require__(0);
...
var Caml_primitive = __webpack_require__(3);
var Caml_builtin_exceptions = __webpack_require__(0);
...
var Char = __webpack_require__(16);
var List = __webpack_require__(17);
var Curry = __webpack_require__(1);
...
var Curry = __webpack_require__(1);
var Js_exn = __webpack_require__(13);
var Caml_array = __webpack_require__(8);
var Caml_exceptions = __webpack_require__(9);
var Caml_builtin_exceptions = __webpack_require__(0);
...
var Lisp = __webpack_require__(28);
var Js_exn = __webpack_require__(13);
var $$String = __webpack_require__(12);
var Browserterm = __webpack_require__(27);
var Caml_builtin_exceptions = __webpack_require__(0);

function js_read_eval_format(program, env) {
  var program_value = Lisp.parse(program);
  var result = Lisp.$$eval(program_value, env);
  var result_formatted = Lisp.format_val(result);
  return "=> " + result_formatted;
}

function js_read_eval_format_catch(input, env) {
  try {
    return js_read_eval_format($$String.trim(input), env);
  }
  catch (raw_exn){
    var exn = Js_exn.internalToOCamlException(raw_exn);
...
function js_read_eval_print_loop(env) {
  Browserterm.await_input((function (input) {
          return js_read_eval_format_catch(input, env);
        }));
  return /* () */0;
}

Browserterm.write_out("\nwelcome to lisp.re\n\n\n\n  here are some things to try:\n\n  add up some numbers:\n    (+ 2 6 8 33 43)\n\n  reverse a list of symbols:\n    (reverse (quote (id buy that for a dollar)))\n\n  define a function to square a number:\n    (define square (lambda (x) (pow x 2)))\n    (square 3)\n\n  calculate the squares of a list of numbers:\n    (define square (lambda (x) (pow x 2)))\n    (map square (list 1 2 3 4 5))\n\n  calculate the arithmetic mean of a list of numbers:\n    (define mean (lambda (lst) (/ (apply + lst) (length lst))))\n    (mean (list 3.0 3.1 4.10 5.1 6.1 6.2 10))\n\n");

var global_env = Lisp.standard_env(/* () */0);

Lisp.load_stdlib(global_env);

js_read_eval_print_loop(global_env);

exports.js_read_eval_format = js_read_eval_format;
exports.js_read_eval_format_catch = js_read_eval_format_catch;
exports.js_read_eval_print_loop = js_read_eval_print_loop;
...
/* WEBPACK VAR INJECTION */(function(process) {process.uptime = function(){
...
var Curry = __webpack_require__(1);
var Js_exn = __webpack_require__(13);
var Printf = __webpack_require__(43);
var $$String = __webpack_require__(12);
var Hashtbl = __webpack_require__(37);
var Caml_obj = __webpack_require__(11);
var Pervasives = __webpack_require__(6);
var Caml_format = __webpack_require__(4);
var Caml_string = __webpack_require__(2);
...
function tokenize(input) {
  ...
  var delimiter_reached = function (delimiter_token) {
    if (state[/* range_end */1] > state[/* range_start */0]) {
      var text = $$String.sub(input, state[/* range_start */0], state[/* range_end */1] - state[/* range_start */0] | 0);
      state[/* tokens */2] = /* :: */[
        /* TextToken */[text],
        state[/* tokens */2]
      ];
    ...
    state[/* range_start */0] = state[/* range_end */1] + 1 | 0;
    state[/* range_end */1] = state[/* range_end */1] + 1 | 0;
    return /* () */0;
  };
  var input_length = input.length;
  while(state[/* range_end */1] < input_length) {
    var current_char = Caml_string.get(input, state[/* range_end */1]);
    var exit = 0;
    var switcher = current_char - 9 | 0;
    if (switcher > 4 || switcher < 0) {
      ...
      if (switcher$1 > 9 || switcher$1 < 0) {
        ...
        switch (switcher$1) {
          ...
          case 6 : 
              ...
              break;
          case 7 : 
              delimiter_reached(/* Some */[/* QuoteToken */2]);
              break;
          case 8 : 
  ...
  delimiter_reached(/* None */0);
  return List.rev(state[/* tokens */2]);
}
...
function format_val(value) {
  switch (value.tag | 0) {
    ...
    case 1 : 
        return value[0];
    case 2 : 
        var formatted_items = List.map(format_val, value[0]);
        var joined = $$String.concat(" ", formatted_items);
        return "(" + (joined + ")");
    case 3 : 
        return "'" + format_val(value[0]);
    case 4 : 
        var formatted_args = $$String.concat(" ", value[0]);
        return "(lambda (" + (formatted_args + (") " + (format_val(value[1]) + ")")));
    case 5 : 
        return "#<procedure " + (value[0] + ">");
...
function atom(text) {
  try {
    return /* NumberVal */Block.__(0, [Caml_format.caml_float_of_string(text)]);
  }
  catch (raw_exn){
    var exn = Js_exn.internalToOCamlException(raw_exn);
    if (exn[0] === Caml_builtin_exceptions.failure) {
      if (exn[1] === "float_of_string") {
        return /* SymbolVal */Block.__(1, [text]);
      } else {
        throw exn;
      }
    } else {
...
function read_from_tokens(remaining_tokens) {
    ...
    if (typeof match$1 === "number") {
      switch (match$1) {
        case 0 : 
            ...
            return read_list_from_tokens(remaining_tokens, /* [] */0);
        case 1 : 
            return Pervasives.failwith("unexpected )");
        case 2 : 
            remaining_tokens[0] = match[1];
            return /* QuotedVal */Block.__(3, [read_from_tokens(remaining_tokens)]);
        
      }
    } else {
      remaining_tokens[0] = match[1];
      return atom(match$1[0]);
    }
  } else {
    return Pervasives.failwith("unexpected EOF while reading");
  }
}

function read_list_from_tokens(remaining_tokens, _values_list) {
  while(true) {
    ...
    if (match) {
      ...
      if (typeof match$1 === "number" && match$1 === 1) {
        remaining_tokens[0] = match[1];
        return /* ListVal */Block.__(2, [List.rev(values_list)]);
      } else {
        exit = 1;
      }
    } else {
      return Pervasives.failwith("unexpected EOF while reading list");
    }
    if (exit === 1) {
      var value = read_from_tokens(remaining_tokens);
      _values_list = /* :: */[
        value,
        values_list
      ];
...
function parse(program) {
  ...
  var value = read_from_tokens(tokens);
  if (tokens[0] !== /* [] */0) {
    var tokens_string = $$String.concat(" ", List.map(format_token, tokens[0]));
    Pervasives.failwith("parsing finished with tokens remaining: " + tokens_string);
  }
  return value;
}

function unwrap_number_value(value) {
  if (value.tag) {
    return Pervasives.failwith("expected number value, got " + format_val(value));
  } else {
    return value[0];
  }
}

function unwrap_symbol_value(value) {
  if (value.tag === 1) {
    return value[0];
  } else {
    return Pervasives.failwith("expected symbol value, got " + format_val(value));
  }
}

function unwrap_list_value(value) {
  if (value.tag === 2) {
    return value[0];
  } else {
    return Pervasives.failwith("expected list value, got " + format_val(value));
  }
}

function apply_arithmetic(func, args) {
  var numbers = List.map(unwrap_number_value, args);
  var result = List.fold_left(func, List.hd(numbers), List.tl(numbers));
  return /* NumberVal */Block.__(0, [result]);
}

var sym_true = /* SymbolVal */Block.__(1, ["#t"]);

var sym_false = /* SymbolVal */Block.__(1, ["#f"]);

var pi = /* NumberVal */Block.__(0, [Math.acos(-1.0)]);

var empty_list = /* ListVal */Block.__(2, [/* [] */0]);

function is_truthy(value) {
  var tmp;
  switch (value.tag | 0) {
    case 1 : 
        tmp = value[0] === "#f" ? /* true */1 : /* false */0;
        break;
    case 2 : 
        tmp = value[0] ? /* false */0 : /* true */1;
        break;
    default:
      tmp = /* false */0;
  }
...
function sym_of_bool(b) {
  if (b !== 0) {
    return /* SymbolVal */Block.__(1, ["#t"]);
  } else {
    return /* SymbolVal */Block.__(1, ["#f"]);
  }
}

function apply_number_comparator(func, args) {
  if (args) {
    var match = args[0];
    if (match.tag) {
      return Pervasives.failwith("expected 2 args of number type");
    } else {
      var match$1 = args[1];
      if (match$1) {
        var match$2 = match$1[0];
        if (!match$2.tag && !match$1[1]) {
          return sym_of_bool(Curry._2(func, match[0], match$2[0]));
        } else {
          return Pervasives.failwith("expected 2 args of number type");
        }
      } else {
...
function are_referentially_equal(args) {
  var tmp;
  if (args) {
    var a = args[0];
    var exit = 0;
      ...
      case 0 : 
          ...
          if (match) {
            ...
            if (match$1.tag) {
              ...
              tmp = match[1] ? Pervasives.failwith("expected 2 args") : +(a[0] === match$1[0]);
            }
          } else {
            tmp = Pervasives.failwith("expected 2 args");
          }
          break;
      case 1 : 
          var match$2 = args[1];
          if (match$2) {
            ...
            if (match$3.tag === 1) {
              tmp = match$2[1] ? Pervasives.failwith("expected 2 args") : +(a[0] === match$3[0]);
            } else {
              exit = 1;
            }
          } else {
    ...
    if (exit === 1) {
      var match$4 = args[1];
      tmp = match$4 && !match$4[1] ? +(a === match$4[0]) : Pervasives.failwith("expected 2 args");
    }
    
  } else {
    tmp = Pervasives.failwith("expected 2 args");
  }
  return sym_of_bool(tmp);
}

function are_structurally_equal(args) {
  var tmp;
  if (args) {
    var a = args[0];
    var exit = 0;
    ...
    if (exit === 1) {
      var match$4 = args[1];
      tmp = match$4 && !match$4[1] ? Caml_obj.caml_equal(a, match$4[0]) : Pervasives.failwith("expected 2 args");
    }
    
  } else {
    tmp = Pervasives.failwith("expected 2 args");
  }
  var retval = sym_of_bool(tmp);
  return retval;
}

function list_length(args) {
  return /* NumberVal */Block.__(0, [args && !args[1] ? List.length(unwrap_list_value(args[0])) : Pervasives.failwith("expected single argument")]);
}

function set_in_env(env, key, value) {
  return Hashtbl.add(env[/* table */0], key, value);
}

function find_env_with_key(_env, key) {
  while(true) {
    var env = _env;
    var match = Hashtbl.mem(env[/* table */0], key);
    if (match !== 0) {
      return /* Some */[env];
    } else {
      var match$1 = env[/* outer */1];
      if (match$1) {
        _env = match$1[0];
        continue ;
...
function update_existing_in_env(env, key, value) {
  var match = find_env_with_key(env, key);
  if (match) {
    set_in_env(match[0], key, value);
    return /* true */1;
  } else {
    return /* false */0;
  }
...
function get_in_env(env, key) {
  return Hashtbl.find(env[/* table */0], key);
}

function create_env(outer) {
  return /* record */[
          /* table */Hashtbl.create(/* None */0, 100),
          /* outer */outer
        ];
}

function dump_env(_$staropt$star, _maybe_env) {
  while(true) {
    var maybe_env = _maybe_env;
    var $staropt$star = _$staropt$star;
    var localonly = $staropt$star ? $staropt$star[0] : /* false */0;
    if (maybe_env) {
      var env = maybe_env[0];
      console.log("Env {");
      Hashtbl.iter((function (k, v) {
              console.log("  " + (k + (": " + format_val(v))));
              return /* () */0;
            }), env[/* table */0]);
      console.log("}");
      if (localonly) {
...
function $$eval(value, env) {
  if (debugger_stepping[0]) {
    console.log("eval: " + format_val(value));
    Pervasives.print_string("(debugger paused)");
    var cmd = /* "0" */48;
    while(cmd !== /* "s" */115) {
      var line = Pervasives.read_line(/* () */0);
      var tmp;
      try {
        tmp = Caml_string.get(line, 0);
      }
      catch (raw_exn){
        var exn = Js_exn.internalToOCamlException(raw_exn);
      ...
      cmd = tmp;
      var match = cmd;
      var switcher = match - 101 | 0;
      if (!(switcher > 7 || switcher < 0)) {
        switch (switcher) {
          case 0 : 
              debugger_stepping[0] = /* false */0;
              break;
          case 2 : 
              dump_env(/* None */0, /* Some */[env]);
              break;
          case 1 : 
          case 3 : 
          case 4 : 
  ...
  switch (value.tag | 0) {
    ...
    case 1 : 
        var name = value[0];
        var match$1 = find_env_with_key(env, name);
        evaluated = match$1 ? Hashtbl.find(match$1[0][/* table */0], name) : Pervasives.failwith("attempted to access undefined variable: " + name);
        break;
    case 2 : 
        var match$2 = value[0];
        if (match$2) {
          var expr_to_call = match$2[0];
          if (expr_to_call.tag === 1) {
            var name_to_call = expr_to_call[0];
            var exit = 0;
            switch (name_to_call) {
              case "debug" : 
                  if (match$2[1]) {
                  ...
                  if (args) {
                    ...
                    if (match$3.tag === 1) {
                      ...
                      if (match$4 && !match$4[1]) {
                        set_in_env(env, match$3[0], $$eval(match$4[0], env));
                        evaluated = sym_false;
                      } else {
                        evaluated = Pervasives.failwith("invalid usage of 'define'");
                      }
                    } else {
                      evaluated = Pervasives.failwith("invalid usage of 'define'");
                    }
              ...
              case "if" : 
                  ...
                  if (args$1) {
                    var match$5 = args$1[1];
                    if (match$5) {
                      var match$6 = match$5[1];
                      if (match$6 && !match$6[1]) {
                        var alt = match$6[0];
                        var conseq = match$5[0];
                        var test = args$1[0];
                        var cond_evaluated = $$eval(test, env);
                        var match$7 = is_truthy(cond_evaluated);
                        evaluated = match$7 !== 0 ? $$eval(conseq, env) : $$eval(alt, env);
                      } else {
                        evaluated = Pervasives.failwith("invalid usage of 'if'");
                      }
                    } else {
                      evaluated = Pervasives.failwith("invalid usage of 'if'");
                    }
                  ...
                  break;
              case "lambda" : 
                  var args$2 = match$2[1];
                  if (args$2) {
                    var match$8 = args$2[0];
                    if (match$8.tag === 2) {
                      var match$9 = args$2[1];
                      evaluated = match$9 && !match$9[1] ? /* CallableVal */Block.__(4, [
                            List.map(unwrap_symbol_value, match$8[0]),
                            match$9[0],
                            create_env(/* Some */[env])
                          ]) : Pervasives.failwith("invalid usage of 'lambda'");
                    } else {
                      evaluated = Pervasives.failwith("invalid usage of 'lambda'");
                    }
                  } else {
                    evaluated = Pervasives.failwith("invalid usage of 'lambda'");
                  }
                  break;
              case "load" : 
                  var args$3 = match$2[1];
                  if (args$3 && args$3[0].tag === 1 && !args$3[1]) {
                    var tokens = [tokenize("")];
                    var last_result = sym_false;
                    while(tokens[0] !== /* [] */0) {
                      var value$1 = read_from_tokens(tokens);
                      last_result = $$eval(value$1, env);
                    };
                    evaluated = last_result;
                  } else {
                    evaluated = Pervasives.failwith("invalid usage of 'load'");
                  }
                  break;
              case "quote" : 
                  var args$4 = match$2[1];
                  evaluated = args$4 && !args$4[1] ? args$4[0] : Pervasives.failwith("invalid usage of 'quote'");
                  break;
              case "set!" : 
                  var match$10 = match$2[1];
                  if (match$10) {
                    var match$11 = match$10[0];
                    if (match$11.tag === 1) {
                      var match$12 = match$10[1];
                      if (match$12 && !match$12[1]) {
                        var match$13 = update_existing_in_env(env, match$11[0], $$eval(match$12[0], env));
                        if (match$13 === 0) {
                          Pervasives.failwith("attempted to 'set!' undefined variable");
                        }
                        evaluated = sym_false;
                      } else {
                        exit = 1;
            ...
            if (exit === 1) {
              var evaluated_args = List.map((function (arg) {
                      return $$eval(arg, env);
                    }), match$2[1]);
              evaluated = call_by_name(name_to_call, evaluated_args, env);
            }
            
          } else {
            var evaluated_expr_to_call = $$eval(expr_to_call, env);
            var evaluated_args$1 = List.map((function (arg) {
                    return $$eval(arg, env);
                  }), match$2[1]);
            evaluated = call_callable(evaluated_expr_to_call, "[dynamic]", evaluated_args$1);
          }
        } else {
          evaluated = empty_list;
        }
        break;
    case 3 : 
        evaluated = value[0];
    ...
    case 4 : 
    case 5 : 
        evaluated = Pervasives.failwith("unknown list form");
        break;
    
  }
  if (debugger_stepping[0]) {
    console.log("result: " + (format_val(value) + (" => " + format_val(evaluated))));
  }
  return evaluated;
}

function call_by_name(name, args, env) {
  var match = find_env_with_key(env, name);
  if (match) {
    return call_callable(Hashtbl.find(match[0][/* table */0], name), name, args);
  } else {
    return Pervasives.failwith("attempted to call undefined function: " + name);
  }
}

function call_callable(maybe_callable, name, args) {
  var retval;
  switch (maybe_callable.tag | 0) {
    case 4 : 
        var arg_names = maybe_callable[0];
        var fn_env = create_env(/* Some */[maybe_callable[2]]);
        try {
          List.iter2((function (name, arg) {
                  return set_in_env(fn_env, name, arg);
                }), arg_names, args);
        }
        catch (raw_exn){
          var exn = Js_exn.internalToOCamlException(raw_exn);
          if (exn[0] === Caml_builtin_exceptions.invalid_argument) {
            if (exn[1] === "List.iter2") {
              var expected_arity = List.length(arg_names);
              var actual_arity = List.length(args);
              Pervasives.failwith("called function " + (name + (" with " + (String(actual_arity) + (" argument(s), expected " + (String(expected_arity) + " argument(s)"))))));
            } else {
              throw exn;
            }
          } else {
        ...
        retval = $$eval(maybe_callable[1], fn_env);
        break;
    case 5 : 
        retval = Curry._1(maybe_callable[1], args);
        break;
    default:
      retval = Pervasives.failwith("expected callable, got " + format_val(maybe_callable));
  }
  return retval;
}

function standard_env() {
  var env = create_env(/* None */0);
  set_in_env(env, "pi", pi);
  set_in_env(env, "#f", sym_false);
  set_in_env(env, "#t", sym_true);
  var define_builtin = function (name, func) {
    return set_in_env(env, name, /* BuiltinCallableVal */Block.__(5, [
                  name,
                  func,
                  env
                ]));
  };
  define_builtin("+", (function (param) {
          return apply_arithmetic((function (prim, prim$1) {
                        return prim + prim$1;
                      }), param);
        }));
  define_builtin("-", (function (param) {
  ...
  define_builtin("mod", (function (param) {
          return apply_arithmetic((function (prim, prim$1) {
                        return prim % prim$1;
                      }), param);
        }));
  define_builtin("<", (function (param) {
          return apply_number_comparator(Caml_obj.caml_lessthan, param);
        }));
  define_builtin(">", (function (param) {
          return apply_number_comparator(Caml_obj.caml_greaterthan, param);
        }));
  define_builtin("<=", (function (param) {
          return apply_number_comparator(Caml_obj.caml_lessequal, param);
        }));
  define_builtin(">=", (function (param) {
          return apply_number_comparator(Caml_obj.caml_greaterequal, param);
        }));
  define_builtin("=", are_structurally_equal);
  define_builtin("abs", (function (args) {
          if (args) {
            var match = args[0];
            if (!match.tag && !args[1]) {
              return /* NumberVal */Block.__(0, [Math.abs(match[0])]);
            } else {
              return Pervasives.failwith("invalid usage of 'abs'");
            }
          } else {
            return Pervasives.failwith("invalid usage of 'abs'");
          }
        }));
  define_builtin("apply", (function (args) {
          if (args) {
            var match = args[1];
            if (match) {
              var match$1 = match[0];
              if (match$1.tag === 2 && !match[1]) {
                var callable_args = match$1[0];
                var maybe_callable = args[0];
                switch (maybe_callable.tag | 0) {
                  case 4 : 
                      return call_callable(maybe_callable, "[lambda]", callable_args);
                  case 5 : 
                      return call_callable(maybe_callable, maybe_callable[0], callable_args);
                  default:
                    return Pervasives.failwith("cannot use 'apply' with non-callable first argument");
                }
              } else {
                return Pervasives.failwith("invalid usage of 'apply'");
              }
            } else {
              return Pervasives.failwith("invalid usage of 'apply'");
            }
  ...
  define_builtin("begin", (function (args) {
          var match = List.rev(args);
          if (match) {
            return match[0];
          } else {
            return Pervasives.failwith("invalid usage of 'begin'");
          }
        }));
  define_builtin("car", (function (args) {
          if (args) {
            var match = args[0];
            if (match.tag === 2) {
              var match$1 = match[0];
              if (match$1) {
                if (args[1]) {
                  return Pervasives.failwith("cannot use car on non-list value");
                } else {
                  return match$1[0];
                }
              } else if (args[1]) {
                ...
                return Pervasives.failwith("cannot use car on empty list");
              }
            } else {
              return Pervasives.failwith("cannot use car on non-list value");
            }
  ...
  define_builtin("cdr", (function (args) {
          var tmp;
          if (args) {
            var match = args[0];
            if (match.tag === 2) {
              var match$1 = match[0];
              tmp = match$1 ? (
                  args[1] ? Pervasives.failwith("cannot use cadr on non-list value") : match$1[1]
                ) : (
                  args[1] ? Pervasives.failwith("cannot use cadr on non-list value") : Pervasives.failwith("cannot use cadr on empty list")
                );
            } else {
              tmp = Pervasives.failwith("cannot use cadr on non-list value");
            }
          } else {
            tmp = Pervasives.failwith("cannot use cadr on non-list value");
          }
          return /* ListVal */Block.__(2, [tmp]);
        }));
  define_builtin("cons", (function (args) {
          var tmp;
          if (args) {
            var match = args[1];
            if (match) {
              var match$1 = match[0];
              tmp = match$1.tag === 2 && !match[1] ? /* :: */[
                  args[0],
                  match$1[0]
                ] : Pervasives.failwith("invalid use of 'cons'");
            } else {
              tmp = Pervasives.failwith("invalid use of 'cons'");
            }
          } else {
            tmp = Pervasives.failwith("invalid use of 'cons'");
          }
  ...
  define_builtin("list", (function (args) {
          return /* ListVal */Block.__(2, [args]);
        }));
  define_builtin("list?", (function (args) {
          var tmp;
          tmp = args ? (
              args[0].tag === 2 ? (
                  args[1] ? Pervasives.failwith("invalid use of 'list?'") : /* true */1
                ) : (
                  args[1] ? Pervasives.failwith("invalid use of 'list?'") : /* false */0
                )
            ) : Pervasives.failwith("invalid use of 'list?'");
          return sym_of_bool(tmp);
        }));
  define_builtin("map", (function (args) {
          if (args) {
            var match = args[1];
            if (match) {
              var match$1 = match[0];
              if (match$1.tag === 2 && !match[1]) {
                var maybe_callable = args[0];
                return /* ListVal */Block.__(2, [List.map((function (v) {
                                  return call_callable(maybe_callable, "[lambda]", /* :: */[
                                              v,
                                              /* [] */0
                                            ]);
                                }), match$1[0])]);
              } else {
                return Pervasives.failwith("invalid usage of 'map'");
              }
            } else {
              return Pervasives.failwith("invalid usage of 'map'");
            }
  ...
  define_builtin("max", (function (param) {
          return apply_arithmetic(Caml_obj.caml_max, param);
        }));
  define_builtin("min", (function (param) {
          return apply_arithmetic(Caml_obj.caml_min, param);
        }));
  define_builtin("not", (function (args) {
          if (args && !args[1]) {
            return sym_of_bool(1 - is_truthy(args[0]));
          } else {
            return Pervasives.failwith("invalid usage of 'not'");
          }
        }));
  define_builtin("null?", (function (args) {
          var tmp;
          if (args) {
            var match = args[0];
            tmp = match.tag === 2 ? (
                match[0] ? (
                    args[1] ? Pervasives.failwith("invalid usage of 'null?'") : /* false */0
                  ) : (
                    args[1] ? Pervasives.failwith("invalid usage of 'null?'") : /* true */1
                  )
              ) : (
                args[1] ? Pervasives.failwith("invalid usage of 'null?'") : /* false */0
              );
          } else {
            tmp = Pervasives.failwith("invalid usage of 'null?'");
          }
          return sym_of_bool(tmp);
        }));
  define_builtin("number?", (function (args) {
          var tmp;
          tmp = args ? (
              args[0].tag ? (
                  args[1] ? Pervasives.failwith("invalid usage of 'number?'") : /* false */0
                ) : (
                  args[1] ? Pervasives.failwith("invalid usage of 'number?'") : /* true */1
                )
            ) : Pervasives.failwith("invalid usage of 'number?'");
          return sym_of_bool(tmp);
        }));
  define_builtin("pow", (function (args) {
          if (args) {
            var match = args[0];
            if (match.tag) {
              return Pervasives.failwith("invalid usage of 'pow'");
            } else {
              var match$1 = args[1];
              if (match$1) {
                var match$2 = match$1[0];
                if (!match$2.tag && !match$1[1]) {
                  return /* NumberVal */Block.__(0, [Math.pow(match[0], match$2[0])]);
                } else {
                  return Pervasives.failwith("invalid usage of 'pow'");
                }
              } else {
  ...
  define_builtin("procedure?", (function (args) {
          var tmp;
          if (args) {
            switch (args[0].tag | 0) {
              case 4 : 
              case 5 : 
                  tmp = args[1] ? Pervasives.failwith("invalid usage of 'procedure?'") : /* true */1;
                  break;
              default:
                tmp = args[1] ? Pervasives.failwith("invalid usage of 'procedure?'") : /* false */0;
            }
          } else {
            tmp = Pervasives.failwith("invalid usage of 'procedure?'");
          }
          return sym_of_bool(tmp);
        }));
  define_builtin("reverse", (function (args) {
          if (args) {
            var match = args[0];
            if (match.tag === 2 && !args[1]) {
              return /* ListVal */Block.__(2, [List.rev(match[0])]);
            } else {
              return Pervasives.failwith("invalid usage of 'reverse'");
            }
          } else {
            return Pervasives.failwith("invalid usage of 'reverse'");
          }
        }));
  define_builtin("round", (function (args) {
          if (args) {
            var match = args[0];
            if (!match.tag && !args[1]) {
              return /* NumberVal */Block.__(0, [Math.floor(match[0])]);
            } else {
              return Pervasives.failwith("invalid usage of 'round'");
            }
          } else {
            return Pervasives.failwith("invalid usage of 'round'");
          }
        }));
  define_builtin("symbol?", (function (args) {
          var tmp;
          tmp = args ? (
              args[0].tag === 1 ? (
                  args[1] ? Pervasives.failwith("invalid usage of 'symbol?'") : /* true */1
                ) : (
                  args[1] ? Pervasives.failwith("invalid usage of 'symbol?'") : /* false */0
                )
            ) : Pervasives.failwith("invalid usage of 'symbol?'");
          return sym_of_bool(tmp);
        }));
  return env;
}

function load_stdlib(env) {
...
function read_eval_print(program, env) {
  var program_value = parse(program);
  var result = $$eval(program_value, env);
  var result_formatted = format_val(result);
  console.log("=> " + result_formatted);
  return /* () */0;
}

function read_eval_print_loop(env) {
  while(true) {
    Pervasives.print_string("lisp.re> ");
    var input = Pervasives.read_line(/* () */0);
    try {
...
exports.debug = debug;
exports.debugger_stepping = debugger_stepping;
exports.format_token = format_token;
exports.tokenize = tokenize;
exports.format_val = format_val;
exports.atom = atom;
exports.read_from_tokens = read_from_tokens;
exports.read_list_from_tokens = read_list_from_tokens;
exports.parse = parse;
exports.unwrap_number_value = unwrap_number_value;
exports.unwrap_symbol_value = unwrap_symbol_value;
exports.unwrap_list_value = unwrap_list_value;
exports.apply_arithmetic = apply_arithmetic;
exports.sym_true = sym_true;
exports.sym_false = sym_false;
exports.pi = pi;
exports.empty_list = empty_list;
exports.is_truthy = is_truthy;
exports.sym_of_bool = sym_of_bool;
exports.apply_number_comparator = apply_number_comparator;
exports.are_referentially_equal = are_referentially_equal;
exports.are_structurally_equal = are_structurally_equal;
exports.list_length = list_length;
exports.set_in_env = set_in_env;
exports.find_env_with_key = find_env_with_key;
exports.update_existing_in_env = update_existing_in_env;
exports.get_in_env = get_in_env;
exports.create_env = create_env;
exports.dump_env = dump_env;
exports.load_file = load_file;
exports.$$eval = $$eval;
exports.call_by_name = call_by_name;
exports.call_callable = call_callable;
exports.standard_env = standard_env;
exports.load_stdlib = load_stdlib;
exports.read_eval_print = read_eval_print;
exports.read_eval_print_loop = read_eval_print_loop;
...
var Caml_int32 = __webpack_require__(5);
var Caml_queue = __webpack_require__(33);
var Caml_builtin_exceptions = __webpack_require__(0);
...
var Caml_float = __webpack_require__(30);
var Caml_int32 = __webpack_require__(5);
var Pervasives = __webpack_require__(6);
var Caml_format = __webpack_require__(4);
var Caml_string = __webpack_require__(2);
...
var Obj = __webpack_require__(42);
var Curry = __webpack_require__(1);
var Caml_exceptions = __webpack_require__(9);
...
var Char = __webpack_require__(16);
var $$String = __webpack_require__(12);
var Caml_md5 = __webpack_require__(32);
var Pervasives = __webpack_require__(6);
var Caml_string = __webpack_require__(2);
var Caml_missing_polyfill = __webpack_require__(10);
var Caml_builtin_exceptions = __webpack_require__(0);
...
var Caml_obj = __webpack_require__(11);
var Caml_hash = __webpack_require__(31);
var Caml_array = __webpack_require__(8);
var Caml_primitive = __webpack_require__(3);
var CamlinternalLazy = __webpack_require__(35);
var Caml_missing_polyfill = __webpack_require__(10);
var Caml_builtin_exceptions = __webpack_require__(0);
...
var Marshal = __webpack_require__(40);
var Caml_array = __webpack_require__(8);
var Caml_missing_polyfill = __webpack_require__(10);
var Caml_builtin_exceptions = __webpack_require__(0);
...
var Buffer = __webpack_require__(20);
var Pervasives = __webpack_require__(6);
var CamlinternalFormat = __webpack_require__(34);
...
var Int64 = __webpack_require__(39);
